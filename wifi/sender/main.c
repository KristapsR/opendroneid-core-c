...
static void drone_set_mock_data(ODID_UAS_Data *drone)
{
	...
	memcpy(drone->Auth[1].AuthData, auth1_data, MINIMUM(sizeof(auth1_data), sizeof(drone->Auth[0].AuthData)));
	drone->Auth[2].AuthType = ODID_AUTH_UAS_ID_SIGNATURE;
	drone->Auth[2].DataPage = 2;
	char auth2_data[] = "34567890123456789";
	memcpy(drone->Auth[2].AuthData, auth2_data, MINIMUM(sizeof(auth2_data), sizeof(drone->Auth[0].AuthData)));
	drone->Auth[3].AuthType = ODID_AUTH_UAS_ID_SIGNATURE;
	drone->Auth[3].DataPage = 3;
	char auth3_data[] = "45678901234567890";
	memcpy(drone->Auth[3].AuthData, auth3_data, MINIMUM(sizeof(auth3_data), sizeof(drone->Auth[0].AuthData)));
	drone->Auth[4].AuthType = ODID_AUTH_UAS_ID_SIGNATURE;
	drone->Auth[4].DataPage = 4;
	char auth4_data[] = "56789012345678901";
	memcpy(drone->Auth[4].AuthData, auth4_data, MINIMUM(sizeof(auth4_data), sizeof(drone->Auth[0].AuthData)));
